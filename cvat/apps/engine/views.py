...
#Ltts changes- importing from ltts changes folders
from cvat.apps.restrictions.models import UserAgreementStatus
from cvat.apps.lttschanges.engine.views import send_email_on_job_assignment
from cvat.apps.lttschanges.authentication.auth import TaskGetQuerySetMixin
...
class ProjectFilter(filters.FilterSet):
    ...
    # Ltts changes- added project_type in project search
...
class TaskViewSet(UploadMixin,TaskGetQuerySetMixin, viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        if self.action == 'list':
            ...
            queryset = perm.filter(queryset)
            print("views query set", queryset)
...
class UserViewSet(viewsets.GenericViewSet, mixins.ListModelMixin,
    ...
    def self(self, request):
        ...
        # """LTTS code changes starts for email verification required by Savita and Kalaiselvi"""
        ...
        return response
        #return Response(serializer.data)
        # """LTTS code changes ends for email verification required by Savita and Kalaiselvi"""

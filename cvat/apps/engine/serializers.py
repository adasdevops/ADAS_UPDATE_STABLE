...
class LabelSerializer(serializers.ModelSerializer):
    ...
    def update_instance(validated_data, parent_instance):
        ...
        if not validated_data.get('id') is None:
            ...
            # Ltts changes for insering project id in Label table start
...
class JobWriteSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        ...
        print("Checking",serializer.data)
...
class ProjectSearchSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        # Ltts changes- for searching project_type

...
from cvat.apps.authentication.views import SigningView
from cvat.apps.lttschanges.authentication.views import RegisterViewEx
...
if settings.DJANGO_AUTH_TYPE == 'BASIC':
    urlpatterns += [
        # Ltts changes added for new reister changes

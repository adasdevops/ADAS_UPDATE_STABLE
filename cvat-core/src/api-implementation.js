...
(() => {
    ...
    function implementAPI(cvat) {
        ...
        // #LTTS changes start
        cvat.reports.get.implementation = async (filter) => {
            checkFilter(filter, {
                id: isInteger,
                training_project_id: isInteger,
            });
            let reports = null;
            reports = await serverProxy.reports.get();
            return reports;
        };
        cvat.reports.generate.implementation = async (id, type) => {
            let reports = null;
            reports = await serverProxy.reports.generate(id, type);
            return reports;
        };

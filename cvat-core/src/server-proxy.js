...
(() => {
    ...
    class ServerProxy {
        constructor() {
            ...
            async function generateReports(id, type) {
                ...
                try {
                    ...
                    response = await Axios.get(`${backendAPI}/project_report?project_id=${id}&format_to_convert=${type}`, {

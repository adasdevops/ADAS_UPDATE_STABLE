 ...
 function build() {
    ...
    const cvat = {
        ...
        server: {
            ...
            // #LTTS New code added by Raju ended above
            /**
        ...
        // #LTTS changes
        /**
         * Namespace is used for getting reports
         * @namespace reports
         * @memberof module:API.cvat
         */
        reports: {
             ...
             */
            /**
                 * Method returns list of reports corresponding to a filter
                 * @method get
                 * @async
                 * @memberof module:API.cvat.reports

                 * @returns {module:API.cvat.classes.Reports[]}
                 * @throws {module:API.cvat.exceptions.PluginError}
                 * @throws {module:API.cvat.exceptions.ServerError}
                 */
            async get(filter = {}) {
                const result = await PluginRegistry.apiWrapper(cvat.reports.get, filter);
                return result;
            },
            ...
            async generate(id, type) {
                const result = await PluginRegistry.apiWrapper(cvat.reports.generate, id, type);
                return result;
            },
        },
        /**
    ...
    // #LTTS changes
    cvat.reports = Object.freeze(cvat.reports);

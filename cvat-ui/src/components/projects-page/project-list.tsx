...
// LTTS# changes start below
import { CombinedState, Project } from '../../../ltts_src/reducers/interfaces';
import ProjectItem from '../../../ltts_src/components/projects-page/project-item';
// LTTS# changes end above

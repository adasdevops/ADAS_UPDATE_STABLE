...
//added icon by LTTS
import Icon, { StopOutlined, CheckCircleOutlined, ClockCircleOutlined} from '@ant-design/icons';
    ...
    return (
        ...
        {/* below code commented by LTTS  */}
            ...
            <Col className='cvat-annotation-header-left-group'>
                ...
                {/* LTTS changes */}
                 <CVATTooltip overlay='Auto-save enabled for every 1 min'>
                    <Button type='link' className='cvat-annotation-header-button'>

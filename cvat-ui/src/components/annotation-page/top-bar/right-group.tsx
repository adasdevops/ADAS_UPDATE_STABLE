...
//#LTTS added image icon
//import image from '../../../assets/keyboard-icon.png';
import image from '../../../../ltts_src/assets/keyboard-icon.png';
        ...
        if (ObjectActivatID.activatedStateID !== null) {
            ...
            Modal.confirm({
                ...
                content:
                    ...
                    'Do you want to delete the selected annotation from the task? ',
    ...
    function DeleteAllObject(key: any): void {
        ...
        if (key === Actions.REMOVE_ANNO) {
            ...
            Modal.confirm({
                ...
                content: `You are going to delete  ${statesCount} annotations from the task. Do you want to
        ...
        <Col className='cvat-annotation-header-right-group'>
            ...
            <CVATTooltip overlay='Delete all annotations'>
                ...
                >
                    ...
                    <span style={{ marginBottom: '-6px', marginLeft: '-2px', paddingTop: '1px' }}> DeleteAll </span>
            ...
            <div>
                ...
                <Select
                    ...
                    disabled={role === 'worker' || role === 'observer' || role === undefined || role === 'user'}

...
import '../styles.scss';
// #LTTS new code changes for file path
import CreateTaskPageContainer from 'containers/create-task-page/create-task-page';
import LoginPageContainer from '../../ltts_src/containers/login-page/login-page';
import RegisterPageContainer from '../../ltts_src/containers/register-page/register-page';
import CreateProjectPageComponent from '../../ltts_src/components/create-project-page/create-project-page';
import Header from '../../ltts_src/components/header/header';
import UserListComponent from '../../ltts_src/components/user-list-page/user-list';
import PageNotFound from '../../ltts_src/components/not-found-page/notfoundpage';
import AgreementConfirmationPage from '../../ltts_src/components/useragreements-acceptance-page/NDA-acceptance-form';
import ReportsPage from '../../ltts_src/components/reports-page/project-report';
// #LTTS new code changes  for file path ended
...
class CVATApplication extends React.PureComponent<CVATAppProps & RouteComponentProps> {
    ...
    public render(): JSX.Element {
        ...
        if (readyForRender) {
            // #LTTS change routing start below

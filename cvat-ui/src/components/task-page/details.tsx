...
export default class DetailsComponent extends React.PureComponent<Props, State> {
    ...
    public render(): JSX.Element {
        // #LTTS added  userGroup
        const {
            activeInference, cancelAutoAnnotation, taskInstance, onTaskUpdate, userGroup,
        } = this.props;
            ...
            <div className='cvat-task-details'>
                ...
                <Row justify='space-between' align='top'>
                    ...
                    <Col md={16} lg={17} xl={17} xxl={18}>
                         {/* #LTTS changes */}
                        {role === 'admin' ? this.renderDescription() : null}

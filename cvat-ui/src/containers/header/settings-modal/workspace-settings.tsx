...
import {
    ...
    switchTextFontSize,
    switchTextPosition,
} from '../../../../ltts_src/actions/settings-actions';
import { CombinedState } from '../../../../ltts_src/reducers/interfaces';
import WorkspaceSettingsComponent from '../../../../ltts_src/components/header/settings-modal/workspace-settings';
// #LTTS change file path end
